...
public class MywishlistupdatePage {
	...
	public void clickYOURORGEdit1() {
		YOURORGANIZATIONedit1.click();
	}


	public void clickPROJECTEVENTEdit2() {
		YOURPROJECTEVENTedit2.click();
	}


	public void clickWLPRODUCTSEdit3() {
		YOURWISHLISTPRODUCTSedit3.click();
	}	


	public void clickWLORDERSviewall() {
	...
	//Update Log
	public void  Updatelog(boolean testscriptrun, String Logmessage) throws Exception
	{
		try {
